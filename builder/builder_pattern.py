...
class MargaritaBuilder:
	"""docstring for MargaritaBuilder"""
	def __init__(self):
	...
	def add_sauce(self):
		...
		time.sleep(STEP_DELAY)
		print('donw with the tomato sauce')
...
class CreamyBaconBuilder:
	"""docstring for CreamyBaconBuilder"""
	def __init__(self):
...
def validate_style(builders):
	try:
		...
		error_msg = 'Sorry, only margarita (key m) and creamy bacon (key b) are available'
		print(error_msg)
		return (False, None)
	return(True, builder)
